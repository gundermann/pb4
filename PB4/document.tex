...
abwickeln.\cite[S 23.]{Vaadin, WingsAllg}\\
...
API abgewickelt wird. Vaadin\footnote{Abbildung 5} hingegen kann diese
Kommunikation auch über einen Portlet-Container abwickeln.
%TODO GOON
...
von Vaadin in Anspruch nehmen. Auch wenn ich hier das Vaadin-Framework
vorgestellt wurde, gibt es zahlreiche andere Web-Frameworks, die dafür in Frage kommen. Vor allem das GWT,
auf dem Vaadin aufsetzt ist ebenfalls ein Kandidat dafür. \\
